    ...
    public class CustomerController : BaseController
    {
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                ...
                {
                    _message = "The customer database is empty";
        ...
        public async Task<IActionResult> Get(int id)
        {
            try
            {
                ...
                {
                    _message = $"The client with the identifier {id} does not exist";
        ...
        public async Task<IActionResult> Post([FromBody] AddUpdateCustomerViewModel model)
        {
            try
            {
                ...
                {
                    _message = "New client could not be added";
                    return BadRequest(_message);
                }
            }
            catch (Exception e)
        ...
        public async Task<IActionResult> Put(int id, [FromBody] AddUpdateCustomerViewModel model)
        {
            try
            {
                ...
                {
                    _message = "The customer details could not be updated";
                    return BadRequest(_message);
                }
            }
            catch (Exception e)
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                if (await _customerRepository.SaveAsync())
                {
                    _message = $"Deleted client with identifier {id}";
                    return Ok(_message);
                }
                else
                {
                    _message = "The client could not be deleted";
                    return BadRequest(_message);
                }
            }
            catch (Exception e)
